...
from kprop.linearsystem import InverseSolver
...
class GaussianFields:
    ...
    def minimize(self, inference=False):
        ...
        Let S denote a diagonal (N x N) matrix, where S_ii = L_i. The energy function can be rewritten as:
        ...
        D = T.diag(T.sum(abs(self.W), axis=0))
        L = D - self.W
